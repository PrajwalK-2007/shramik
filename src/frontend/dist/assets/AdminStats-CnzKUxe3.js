import { o as commonjsGlobal, n as getDefaultExportFromCjs, r as reactExports, Q as clsx, R as React, T as invariant, u as useGlobalTranslation, t as usePlatformStats, w as useVerifiedWorkers, v as usePendingWorkers, U as Users, C as Clock, j as jsxRuntimeExports } from "./index-d2ZIbWtv.js";
...
import { U as UserPlus } from "./user-plus-Do_iZOTh.js";
import { S as ShieldCheck } from "./shield-check-C2yiF5gk.js";
import { C as CircleAlert } from "./circle-alert-CdwTlDai.js";
import { I as IndianRupee } from "./indian-rupee-BwWOrL5x.js";
...
function getAvailabilityLabel(a2) {
  const start = Number.parseInt(a2.startTime.split(":")[0], 10);
  const end = Number.parseInt(a2.endTime.split(":")[0], 10);
...
function AdminStatsPage() {
  const { t: t2 } = useGlobalTranslation();
  ...
  const availabilityDistribution = (() => {
    ...
    return Object.entries(counts).map(([name, count]) => ({ name, count })).sort((a2, b2) => b2.count - a2.count);
  })();
  const avgRateByProfession = (() => {
    var _a;
    const byProfession = {};
    for (const w of allWorkers) {
      const label = ((_a = PROFESSIONS.find((p2) => p2.value === w.profession)) == null ? void 0 : _a.label) ?? w.profession;
      if (!byProfession[label]) byProfession[label] = { total: 0, count: 0 };
      byProfession[label].total += w.hourly_rate;
      byProfession[label].count += 1;
    }
    return Object.entries(byProfession).map(([profession, { total, count }]) => ({
      name: profession.length > 14 ? `${profession.slice(0, 14)}…` : profession,
      avgRate: Math.round(total / count)
    })).sort((a2, b2) => b2.avgRate - a2.avgRate).slice(0, 10);
  })();
  const statItems = stats ? [
    {
      icon: Users,
      label: t2("admin.totalWorkers"),
  ...
  const barData = ((stats == null ? void 0 : stats.top_professions) ?? []).slice(0, 10).map((p2) => ({
    name: p2.profession.length > 12 ? `${p2.profession.slice(0, 12)}…` : p2.profession,
    count: p2.count
  }));
  const verificationRate = stats && stats.total_workers > 0 ? Math.round(stats.verified_workers / stats.total_workers * 100) : 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-8", "data-ocid": "admin_stats.page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-display-lg text-foreground", children: t2("admin.stats") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: "Platform performance overview and analytics" })
    ] }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: ["a", "b", "c", "d", "e", "f"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-xl" }, k2))
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-3 gap-4 mb-8", children: statItems.map(({ icon: Icon, label, value, color: color2, bg }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "border-border shadow-card",
        "data-ocid": "admin_stats.stat_card",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `w-11 h-11 rounded-xl ${bg} flex items-center justify-center flex-shrink-0`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-5 h-5 ${color2}` })
            }
          ),
    ...
    stats && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground text-sm", children: "Overall Verification Rate" }),
    ...
    stats && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8", children: [
      barData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "border-border shadow-card",
          "data-ocid": "admin_stats.bar_chart_card",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground mb-4", children: "Top Professions by Workers" }),
      ...
      pieData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground mb-4", children: "Worker Status Breakdown" }),
      ...
      availabilityDistribution.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "border-border shadow-card",
          "data-ocid": "admin_stats.availability_chart_card",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground mb-4", children: "Availability Distribution" }),
      ...
      avgRateByProfession.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "border-border shadow-card",
          "data-ocid": "admin_stats.avg_rate_chart_card",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground mb-4", children: "Avg. Rate by Profession (\\u20B9/hr)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
    ...
    stats && stats.top_professions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "border-border shadow-card",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: stats.top_professions.slice(0, 10).map(({ profession, count }, i) => {
            var _a, _b;
            const maxCount = ((_a = stats.top_professions[0]) == null ? void 0 : _a.count) ?? 1;
            const pct = Math.round(count / maxCount * 100);
            const profLabel = ((_b = PROFESSIONS.find((p2) => p2.value === profession)) == null ? void 0 : _b.label) ?? profession;
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground truncate max-w-[200px]", children: profLabel }),
